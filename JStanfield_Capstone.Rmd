...
```{r}
menuURL <- "https://www.allmenus.com/nh/manchester/39813-the-yard-seafood-steakhouse/menu/"

menuURL_html <- read_html(menuURL)

menuURL_node <- html_node(menuURL_html, css = ".item-title")

menuURL_text <- html_text(menuURL_node)
