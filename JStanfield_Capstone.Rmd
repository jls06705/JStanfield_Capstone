...
all_menu_links <- c(all_menu_links, menulinks.df)

}

str(all_menu_links)
all_menu_links$unlinks -> totalLinks
totalLinks

linksFinal <- data.frame(character())

for (k in totalLinks) {
  
  ifelse(is.na(totalLinks[k]), print("All done"), paste0("https://www.allmenus.com/", totalLinks[k]) ) -> temp1
  
  gsub(" ", "", temp1, fixed = TRUE) -> temp2
